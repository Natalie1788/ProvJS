...
/*const getCurrentDateTime = function () { //------------------------------det är kommenterat nu för att undvika namndubletter
  const now = new Date();
...
/*function stringIncludes(string, substring) { //------------------------------det är kommenterat nu för att undvika namndubletter
...
/*const removeNegatives = numbers.filter(function (number) { -----------------det är kommenterat nu för att undvika namndubletter
  return number >= 0;
});*/
...
/*function logMessageLater() {   -------------det är kommenterat nu för att undvika namndubletter
  setTimeout(function () {
